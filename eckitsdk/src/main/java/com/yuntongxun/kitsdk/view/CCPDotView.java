...
public class CCPDotView extends LinearLayout {
    ...
    private int defaultNormal = R.drawable.ytx_page_normal;
    private int defaultActive = R.drawable.ytx_page_active;
    ...
    public void initDotResource() {
        defaultNormal = R.drawable.ytx_page_normal_dark;
        defaultActive = R.drawable.ytx_page_active_dark;
    }
    ...
    public void setDotCount(int count) {
        ...
        while (count != 0) {
            ImageView imageControl = (ImageView) View.inflate(getContext(), R.layout.ytx_ccppage_control_image, null);
