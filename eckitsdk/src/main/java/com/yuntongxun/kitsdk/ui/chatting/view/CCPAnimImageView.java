...
public class CCPAnimImageView extends TextView {
	...
	public void initCCPAnimImageView() {
		...
		Drawable chattingFDrawale1 = getResources().getDrawable(R.drawable.voice_left_03);
		...
		Drawable chattingFDrawale2 = getResources().getDrawable(R.drawable.voice_left_02);
		...
		Drawable chattingFDrawale3 = getResources().getDrawable(R.drawable.voice_left_01);
		...
		Drawable chattingTDrawable_1 = getResources().getDrawable(R.drawable.voice_right_03);
		...
		Drawable chattingTDrawable_2 = getResources().getDrawable(R.drawable.voice_right_02);
		...
		Drawable chattingTDrawable_3 = getResources().getDrawable(R.drawable.voice_right_01);
	...
	public final void restBackground() {
		if(isFrom) {
			setBackgroundDrawable(getResources().getDrawable(R.drawable.ytx_chatfrom_bg));
			return;
		}
		setBackgroundDrawable(getResources().getDrawable(R.drawable.ytx_chatto_bg));
	}
