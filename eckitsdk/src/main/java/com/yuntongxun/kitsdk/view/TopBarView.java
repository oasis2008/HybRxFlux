...
//        setBackgroundDrawable(getResources().getDrawable(R.drawable.actionbar_background));
//        setBackgroundDrawable(new ColorDrawable(mContext.getResources().getColor(R.color.red_btn_color_normal)));
        LayoutInflater.from(getContext()).inflate(R.layout.ytx_common_view_top_bar, this, true);
